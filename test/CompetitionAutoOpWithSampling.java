...
public class CompetitionAutoOpWithSampling extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        */
        ...
        telemetry.addData("GoldPos", robot.goldPos);
        ...
        if (opModeIsActive()) {
            ...
            if (robot.goldPos == 0) {
                gyroTurn(0.8, robot.getHeading() + 60, gyroCoef60);
