...
@Autonomous(name = "Depot Facing Auto", group = "CompetitionBot")
public class CompetitionAutoOpDepot extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       */
        ...
        if (opModeIsActive()) {
            gyroTurn(0.5, robot.getHeading() + 40, gyroCoef90); // 45 is theoretical
            startTimer();
            while (runtime.seconds() < 1) {
                //idle time
            }
